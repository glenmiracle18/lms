...
import { CourseActions } from "./chapters/_components/course-actions";
...
const CourseIdPage = async ({ params }: { params: { courseId: string } }) => {
  ...
  const course = await db.course.findUnique({
    ...
    include: {
      //extending the course attachments and chapters
      chapters: {
        orderBy: {
          position: "asc",
        },
  ...
  return (
    <>
      {!course.isPublished && (
        <Banner
          label="This course it not published. Students will not be able to view this course in the course page."
          variant="warning"
        />
      )}
      <div className="p-6">
